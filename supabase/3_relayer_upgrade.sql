-- Aura Sovereign Infrastructure: Oracle Relayer Preparation
...
BEGIN
    ...
    -- If destination address is provided (Egress), use it. Otherwise, use relational defaults.
    ...
    RETURN jsonb_build_object('success', true, 'message', 'Asset Bridge Operation Queued for Relayer');
END;
